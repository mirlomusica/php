        ...
        <section id="central">
            ...
            <article>
                ...
                if (($user = filter_input(INPUT_COOKIE, 'user')) != null) {
                    ...
                    if ($level > 2) {
                        //print "<p><a href=\"../views/challenges/TestCountryView.php\">Acceso directo a pagina</a></p>\n";
                        print "<p><a href=\"../controllers/challenges/ArrayChallengeController.php\">Superar el repte amb Arrays</a></p>\n";
                    }
                } else {
