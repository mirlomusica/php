...
<div class="container">
  <main id="content" role="main" class="middle-align">
    <?php
      $vw_sports_theme_lay = get_theme_mod( 'vw_sports_single_post_sidebar_layout','Right Sidebar');
      if($vw_sports_theme_lay == 'Left Sidebar'){ ?>
      <div class="row">
        <div class="col-lg-4 col-md-4" id="sidebar"><?php get_sidebar();?></div>
        <div id="our-services" class="services col-lg-8 col-md-8">
          <?php if(get_theme_mod('vw_sports_single_post_breadcrumb',true) == 1){ ?>
            <div class="bradcrumbs">
                <?php vw_sports_the_breadcrumb(); ?>
            </div>
          <?php }?>
          <?php if ( have_posts() ) :
            /* Start the Loop */
