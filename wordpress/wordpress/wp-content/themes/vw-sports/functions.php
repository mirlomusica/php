...
function vw_sports_setup() {
	...
	if ( is_admin() && $pagenow === 'themes.php' && (!isset($_GET['page']) || $_GET['page'] !== 'vw_sports_guide')
) {
...
function vw_sports_activation_notice() {
	...
	$vw_sports_meta = get_option( 'vw_sports_admin_notice' );

	if (!$vw_sports_meta) {
		echo '<div id="vw-sports-welcome-notice" class="notice notice-success is-dismissible welcome-notice">';
		echo '<div class="notice-row">';
			echo '<div class="notice-img2">';
				echo '<img src="' . esc_url( get_template_directory_uri() . '/screenshot.png' ) . '" width="180" alt="' . esc_attr__( 'VW Sports', 'vw-sports' ) . '" />';
			echo '</div>';	

			echo '<div class="notice-text">';
				echo '<p class="welcome-text1">'. esc_html__( 'Thanks For Installing VW Sports, You Rock !', 'vw-sports' ) .'</p>';
				echo '<p class="welcome-text3">'. esc_html__( 'Take benefit of a variety of features, functionalities, elements, and an exclusive set of customization options to build your own professional charity website. Please Click on the link below to know the theme setup information.', 'vw-sports' ) .'</p>';
				echo '<span class="import-btn"><a href="'. esc_url( admin_url( 'themes.php?page=vw_sports_guide' ) ) .'" class="button button-primary">'. esc_html__( 'Import Demo', 'vw-sports' ) .'</a></span>';
				echo '<span class="demo-btn"><a href="'. esc_url( 'https://demos.buywptemplates.com/bwt-sports-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'Pro Demo', 'vw-sports' ) .'</a></span>';
				
				echo '<span class="bundle-btn"><a href="'. esc_url( 'https://demos.buywptemplates.com/demo/docs/free-bwt-sports/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'Free Doc', 'vw-sports' ) .'</a></span>';
				echo '<span class="upgrade-btn"><a href="'. esc_url( 'http://buywptemplates.com/products/wordpress-sports-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'Upgrade To Pro', 'vw-sports' ) .'</a></span>';
			echo '</div>';
		echo '</div>';	
	echo '</div>';
}
...
function vw_sports_font_url() {
	...
	return $font_url;
	$contents = vw_sports_wptt_get_webfont_url( esc_url_raw( $fonts_url ) );
}
...
function vw_sports_init_setup() {
	...
	define('VW_SPORTS_FREE_THEME_DOC',__('https://demos.buywptemplates.com/demo/docs/free-bwt-sports/','vw-sports'));
	...
	define('VW_SPORTS_BUY_NOW',__('http://buywptemplates.com/products/wordpress-sports-theme','vw-sports'));
	define('VW_SPORTS_PRO_SUPPORT',__('https://www.buywptemplates.com/pages/community','vw-sports'));
	define('VW_SPORTS_LIVE_DEMO',__('https://demos.buywptemplates.com/bwt-sports-pro/','vw-sports'));
	define('VW_SPORTS_PRO_DOC',__('https://demos.buywptemplates.com/demo/docs/bwt-sports-pro/','vw-sports'));
	...
	define('VW_SPORTS_CREDIT',__('https://www.buywptemplates.com/products/free-wordpress-sports-theme','vw-sports'));
...
add_action( 'after_setup_theme', 'vw_sports_init_setup' );		

// Admin notice code START
function vw_sports_dismissed_notice() {
	update_option( 'vw_sports_admin_notice', true );
}
add_action( 'wp_ajax_vw_sports_dismissed_notice', 'vw_sports_dismissed_notice' );

//After Switch theme function
add_action('after_switch_theme', 'vw_sports_getstart_setup_options');
function vw_sports_getstart_setup_options () {
	update_option('vw_sports_admin_notice', false );
}
