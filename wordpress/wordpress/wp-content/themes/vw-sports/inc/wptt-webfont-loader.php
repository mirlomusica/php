...
if ( ! function_exists( 'vw_sports_vw_sports_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function vw_sports_vw_sports_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'vw_sports_vw_sports_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function vw_sports_vw_sports_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new VW_Sports_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
