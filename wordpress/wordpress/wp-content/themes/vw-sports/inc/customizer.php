...
function vw_sports_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'vw_sports_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="http://buywptemplates.com/products/wordpress-sports-theme">GET PRO</a>','vw-sports'),
		'panel' => 'vw_sports_homepage_panel'
	) );
	...
	$wp_customize->add_control( 'vw_sports_slider_opacity_color', array(
		...
		'choices' => array(
	      '0' =>  esc_attr( __('0','vw-sports')),
	      '0.1' =>  esc_attr( __('0.1','vw-sports')),
	      '0.2' =>  esc_attr( __('0.2','vw-sports')),
	      '0.3' =>  esc_attr( __('0.3','vw-sports')),
	      '0.4' =>  esc_attr( __('0.4','vw-sports')),
	      '0.5' =>  esc_attr( __('0.5','vw-sports')),
	      '0.6' =>  esc_attr( __('0.6','vw-sports')),
	      '0.7' =>  esc_attr( __('0.7','vw-sports')),
	      '0.8' =>  esc_attr( __('0.8','vw-sports')),
	      '0.9' =>  esc_attr( __('0.9','vw-sports'))
	),'active_callback' => 'vw_sports_default_slider'
	));
	...
	$wp_customize->add_control('vw_sports_landscaping_latest_results_btn',array(
		'description' => "<a class='go-pro' target='_blank' href=".esc_url(VW_SPORTS_BUY_NOW).">More Info</a>",
		'section'=> 'vw_sports_landscaping_latest_results',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section('vw_sports_services',array(
		...
		'description' => __('For more options of game section </br> <a class="go-pro-btn" target="blank" href="http://buywptemplates.com/products/wordpress-sports-theme">GET PRO</a>','vw-sports'),
		'panel' => 'vw_sports_homepage_panel',
	));

	$wp_customize->add_setting('vw_sports_services_title',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_services_title',array(
	...
	$wp_customize->add_section('vw_sports_footer',array(
		...
		'panel' => 'vw_sports_homepage_panel',
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="http://buywptemplates.com/products/wordpress-sports-theme">GET PRO</a>','vw-sports'),
	));
    ...
    $wp_customize->add_setting('vw_sports_align_footer_social_icon',array(
        'default' => 'center',
        'sanitize_callback' => 'vw_sports_sanitize_choices'
	));
	$wp_customize->add_control('vw_sports_align_footer_social_icon',array(
        'type' => 'select',
        'label' => __('Social Icon Alignment ','vw-sports'),
        'section' => 'vw_sports_footer',
        'choices' => array(
            'left' => __('Left','vw-sports'),
            'right' => __('Right','vw-sports'),
	...
	$wp_customize->add_setting( 'vw_sports_copyright_sticky',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_sports_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_copyright_sticky',array(
      'label' => esc_html__( 'Show / Hide Sticky Copyright','vw-sports' ),
      'section' => 'vw_sports_footer'
    )));

   $wp_customize->add_setting('vw_sports_footer_social_icons_font_size',array(
       'default'=> 16,
       'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_sports_footer_social_icons_font_size',array(
    'label' => __('Social Icon Font Size','vw-sports'),
    	'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('vw_sports_show_first_caps', array(
	    'default'           => false,
	    'transport'         => 'refresh',
	    'sanitize_callback' => 'vw_sports_switch_sanitization',
	));

	$wp_customize->add_control(new Vw_sports_Toggle_Switch_Custom_Control(
	    $wp_customize,
	    'vw_sports_show_first_caps',
	    array(
	        'label'   => esc_html__('First Cap (First Capital Letter)', 'vw-sports'),
	        'section' => 'vw_sports_post_settings',
	    )
	));
	...
	$wp_customize->add_setting( 'vw_sports_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'vw_sports_switch_sanitization'
  	));
	  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_related_toggle_postdate',array(
	    'label' => esc_html__( 'Show / Hide Post Date','vw-sports' ),
	    'section' => 'vw_sports_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_sports_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Sports_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_sports_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','vw-sports'),
	    'transport' => 'refresh',
	    'section' => 'vw_sports_related_posts_settings',
	    'setting' => 'vw_sports_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_sports_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','vw-sports' ),
		'section' => 'vw_sports_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_sports_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Sports_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_sports_related_author_icon',array(
	    'label' => __('Add Author Icon','vw-sports'),
	    'transport' => 'refresh',
	    'section' => 'vw_sports_related_posts_settings',
	    'setting' => 'vw_sports_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_sports_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','vw-sports' ),
		'section' => 'vw_sports_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_sports_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Sports_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_sports_related_comments_icon',array(
	    'label' => __('Add Comments Icon','vw-sports'),
	    'transport' => 'refresh',
	    'section' => 'vw_sports_related_posts_settings',
	    'setting' => 'vw_sports_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_sports_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','vw-sports' ),
		'section' => 'vw_sports_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_sports_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Sports_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_sports_related_time_icon',array(
	    'label' => __('Add Time Icon','vw-sports'),
	    'transport' => 'refresh',
	    'section' => 'vw_sports_related_posts_settings',
	    'setting' => 'vw_sports_related_time_icon',
	    'type'    => 'icon'
  	)));

  	$wp_customize->add_setting('vw_sports_related_post_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_related_post_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','vw-sports'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','vw-sports'),
		'section'=> 'vw_sports_related_posts_settings',
		'type'=> 'text'
	...
	$wp_customize->add_setting( 'vw_sports_related_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-sports' ),
		'section' => 'vw_sports_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'vw_sports_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_sports_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_sports_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','vw-sports' ),
		'section'     => 'vw_sports_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('vw_sports_related_button_text',array(
		'default'=> esc_html__('Read More','vw-sports'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_related_button_text',array(
		'label'	=> esc_html__('Add Button Text','vw-sports'),
		'input_attrs' => array(
      'placeholder' => esc_html__( 'Read More', 'vw-sports' ),
        ),
	...
	$wp_customize->add_setting( 'vw_sports_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_sports_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_sports_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','vw-sports' ),
		'section'     => 'vw_sports_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting(
		'vw_sports_featured_image_hover',
		array(
			'default'           => 'none',
			'sanitize_callback' => 'sanitize_text_field',
		)
	...
	$wp_customize->add_control(
		'vw_sports_featured_image_hover',
		array(
			'label'   => __( 'Featured Image Hover Effect', 'vw-sports' ),
			'section' => 'vw_sports_single_blog_settings',
			'type'    => 'select',
			'choices' => array(
				'none'      => __( 'None', 'vw-sports' ),
				'zoom-in'   => __( 'Zoom In', 'vw-sports' ),
				'zoom-out'  => __( 'Zoom Out', 'vw-sports' ),
				'scale'     => __( 'Scale', 'vw-sports' ),
				'grayscale' => __( 'Grayscale', 'vw-sports' ),
				'blur'      => __( 'Blur', 'vw-sports' ),
				'bright'    => __( 'Bright', 'vw-sports' ),
				'sepia'     => __( 'Sepia', 'vw-sports' ),
				'translate' => __( 'Translate', 'vw-sports' ),
			),
		)
	);
    ...
    $wp_customize->add_setting( 'vw_sports_grid_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_grid_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-sports' ),
		'section' => 'vw_sports_grid_layout_settings'
  	)));
	...
	// Progress Bar
	$wp_customize->add_setting( 'vw_sports_progress_bar', array(
		'default'           => 0, 
		'transport'         => 'refresh',
		'sanitize_callback' => 'vw_sports_switch_sanitization',
	));
	...
	$wp_customize->add_control(
		new VW_Sports_Toggle_Switch_Custom_Control(
			$wp_customize,
			'vw_sports_progress_bar',
			array(
				'label'   => esc_html__( 'Show / Hide Progress Bar', 'vw-sports' ),
				'section' => 'vw_sports_left_right',
			)
		)
	);
    ...
    //Sticky Header
	$wp_customize->add_setting( 'vw_sports_sticky_header',array(
        'default' => 0,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_sports_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_sticky_header',array(
        'label' => esc_html__( 'Sticky Header','vw-sports' ),
        'section' => 'vw_sports_left_right'
    )));
	...
	$wp_customize->add_setting('vw_sports_bradcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'vw_sports_sanitize_choices'
	));
	$wp_customize->add_control('vw_sports_bradcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Bradcrumbs Alignment','vw-sports'),
        'section' => 'vw_sports_left_right',
        'choices' => array(
            'Left' => __('Left','vw-sports'),
            'Right' => __('Right','vw-sports'),
	...
	$wp_customize->add_setting( 'vw_sports_sticky_sidebar',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_sports_switch_sanitization'
    ) );
    $wp_customize->add_control( new Vw_sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_sticky_sidebar',array(
      'label' => esc_html__( 'Show / Hide Sticky Sidebar','vw-sports' ),
      'section' => 'vw_sports_left_right'
    )));
	...
	$wp_customize->add_setting( 'vw_sports_stickyheader_hide_show',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_sports_switch_sanitization'
    ));
    $wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_stickyheader_hide_show',array(
      'label' => esc_html__( 'Sticky Header','vw-sports' ),
    ...
    $wp_customize->add_setting( 'vw_sports_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_sports_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Sports_Toggle_Switch_Custom_Control( $wp_customize, 'vw_sports_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','vw-sports' ),
        'section' => 'vw_sports_responsive_media'
    )));
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new VW_Sports_Customize_Section_Pro( $manager,'vw_sports_go_pro', array(
			...
			'pro_url'  => esc_url('http://buywptemplates.com/products/wordpress-sports-theme'),
		) )	);
		...
		$manager->add_section(new VW_Sports_Customize_Section_Pro($manager,'vw_sports_get_started_link',array(
			...
			'pro_url'  => esc_url('https://demos.buywptemplates.com/demo/docs/free-bwt-sports/'),
		)));
	}
