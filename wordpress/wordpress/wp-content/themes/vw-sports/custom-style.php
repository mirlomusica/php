<?php
	...
	$vw_sports_resp_stickyheader = get_theme_mod( 'vw_sports_stickyheader_hide_show',false);
	if($vw_sports_resp_stickyheader == true && get_theme_mod( 'vw_sports_sticky_header',false) != true){
    	$vw_sports_custom_css .='.header-fixed{';
			$vw_sports_custom_css .='position:static;';
		$vw_sports_custom_css .='} ';
	}
    if($vw_sports_resp_stickyheader == true){
    	$vw_sports_custom_css .='@media screen and (max-width:575px) {';
		$vw_sports_custom_css .='.header-fixed{';
			$vw_sports_custom_css .='position:fixed;';
		$vw_sports_custom_css .='} }';
	}else if($vw_sports_resp_stickyheader == false){
		$vw_sports_custom_css .='@media screen and (max-width:575px){';
		$vw_sports_custom_css .='.header-fixed{';
			$vw_sports_custom_css .='position:static;';
		$vw_sports_custom_css .='} }';
	...
	if($vw_sports_resp_slider == true && get_theme_mod( 'vw_sports_slider_arrows', true) == false){
	...
	if($vw_sports_featured_image_box_shadow != false){
		$vw_sports_custom_css .='.box-image img, #content-vw img{';
	...
	$vw_sports_related_image_box_shadow = get_theme_mod('vw_sports_related_image_box_shadow',0);
	if($vw_sports_related_image_box_shadow != false){
		$vw_sports_custom_css .='.related-post .box-image img{';
			$vw_sports_custom_css .='box-shadow: '.esc_attr($vw_sports_related_image_box_shadow).'px '.esc_attr($vw_sports_related_image_box_shadow).'px '.esc_attr($vw_sports_related_image_box_shadow).'px #cccccc;';
		$vw_sports_custom_css .='}';
	}
	...
	$vw_sports_button_letter_spacing = get_theme_mod('vw_sports_button_letter_spacing');
	...
	if($vw_sports_copyright_alignment != false){
		$vw_sports_custom_css .='.copyright p,#footer-2 p{';
	...
	$vw_sports_resp_stickycopyright = get_theme_mod( 'vw_sports_stickycopyright_hide_show',false);
	if($vw_sports_resp_stickycopyright == true && get_theme_mod( 'vw_sports_copyright_sticky',false) != true){
    	$vw_sports_custom_css .='.copyright-sticky{';
			$vw_sports_custom_css .='position:static;';
		$vw_sports_custom_css .='} ';
	}

	$vw_sports_footer_social_icons_font_size = get_theme_mod('vw_sports_footer_social_icons_font_size','16');
	$vw_sports_custom_css .='.copyright .widget i{';
		$vw_sports_custom_css .='font-size: '.esc_attr($vw_sports_footer_social_icons_font_size).'px;';
	$vw_sports_custom_css .='}';

	$vw_sports_align_footer_social_icon = get_theme_mod('vw_sports_align_footer_social_icon');
	if($vw_sports_align_footer_social_icon != false){
		$vw_sports_custom_css .='.copyright .widget{';
			$vw_sports_custom_css .='text-align: '.esc_attr($vw_sports_align_footer_social_icon).';';
		$vw_sports_custom_css .='}';
		$vw_sports_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	$vw_sports_singlepost_image_box_shadow = get_theme_mod('vw_sports_singlepost_image_box_shadow',0);
	if($vw_sports_singlepost_image_box_shadow != false){
		$vw_sports_custom_css .='.feature-box img{';
			$vw_sports_custom_css .='box-shadow: '.esc_attr($vw_sports_singlepost_image_box_shadow).'px '.esc_attr($vw_sports_singlepost_image_box_shadow).'px '.esc_attr($vw_sports_singlepost_image_box_shadow).'px #cccccc;';
		$vw_sports_custom_css .='}';
	}
	...
	$vw_sports_responsive_preloader_hide = get_theme_mod('vw_sports_responsive_preloader_hide',false);
	if($vw_sports_responsive_preloader_hide == true && get_theme_mod('vw_sports_loader_enable',false) == false){
		$vw_sports_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$vw_sports_custom_css .='display:none !important;';
		$vw_sports_custom_css .='} }';
	}

	if($vw_sports_responsive_preloader_hide == false){
		$vw_sports_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$vw_sports_custom_css .='display:none !important;';
		$vw_sports_custom_css .='} }';
	...
	$vw_sports_bradcrumbs_alignment = get_theme_mod( 'vw_sports_bradcrumbs_alignment','Left');
    if($vw_sports_bradcrumbs_alignment == 'Left'){
    	$vw_sports_custom_css .='@media screen and (min-width:768px) {';
		$vw_sports_custom_css .='.bradcrumbs{';
			$vw_sports_custom_css .='text-align:start;';
		$vw_sports_custom_css .='}}';
	}else if($vw_sports_bradcrumbs_alignment == 'Center'){
		$vw_sports_custom_css .='@media screen and (min-width:768px) {';
		$vw_sports_custom_css .='.bradcrumbs{';
			$vw_sports_custom_css .='text-align:center;';
		$vw_sports_custom_css .='}}';
	}else if($vw_sports_bradcrumbs_alignment == 'Right'){
		$vw_sports_custom_css .='@media screen and (min-width:768px) {';
		$vw_sports_custom_css .='.bradcrumbs{';
			$vw_sports_custom_css .='text-align:end;';
		$vw_sports_custom_css .='}}';
	}

	// sticky sidebar
		$vw_sports_resp_stickysidebar = get_theme_mod( 'vw_sports_stickysidebar_hide_show',false);
	if($vw_sports_resp_stickysidebar == true && get_theme_mod( 'vw_sports_sticky_sidebar',false) != true){
		$vw_sports_custom_css .= '@media (min-width: 768px) {';
    	$vw_sports_custom_css .='#sidebar{';
			$vw_sports_custom_css .='position:static;';
		$vw_sports_custom_css .='} ';
		$vw_sports_custom_css .= '}';
	...
	$vw_sports_show_first_caps = get_theme_mod('vw_sports_show_first_caps', false);
	if ($vw_sports_show_first_caps ) {
	    $vw_sports_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $vw_sports_custom_css .=' font-size: 55px;font-weight: 600;margin-right: 5px;';
	    $vw_sports_custom_css .='}';
	} else {
		$vw_sports_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $vw_sports_custom_css .= 'display: none;';
	...
	$vw_sports_show_featured = get_theme_mod( 'vw_sports_featured_image_hide_show', 1 );
	$vw_sports_hover_effect  = get_theme_mod( 'vw_sports_featured_image_hover', 'none' );

	if ( $vw_sports_show_featured && $vw_sports_hover_effect !== 'none' ) {

		$vw_sports_custom_css .= '
		.vw-sports-featured-image img{
			transition: all 0.4s ease;
		}';

		if ( $vw_sports_hover_effect === 'zoom-in' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image:hover img{
				transform: scale(1.2);
			}';
		}

		if ( $vw_sports_hover_effect === 'zoom-out' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image img{
				transform: scale(1.2);
			}
		...
		if ( $vw_sports_hover_effect === 'grayscale' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image img{
		...
		if ( $vw_sports_hover_effect === 'sepia' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image:hover img{
				filter: sepia(100%);
			}';
		...
		if ( $vw_sports_hover_effect === 'blur' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image:hover img{
				filter: blur(3px);
			}';
		...
		if ( $vw_sports_hover_effect === 'bright' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image:hover img{
		...
		if ( $vw_sports_hover_effect === 'translate' ) {
			$vw_sports_custom_css .= '
			.vw-sports-featured-image:hover img{
