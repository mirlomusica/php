...
?>
    ...
    <footer role="contentinfo">
            ...
            <aside id="footer" class="copyright-wrapper" role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'vw-sports' ); ?>">
                <div class="container">
                    ...
                    <div class="row wow bounceInUp center delay-1000" data-wow-duration="2s">
                        <div class="<?php echo !is_active_sidebar('footer-1') ? 'footer_hide' : esc_attr($vw_sports_colmd); ?> col-lg-3 col-xs-12 col-md-3 footer-block">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-2') ? 'footer_hide' : esc_attr($vw_sports_colmd); ?> col-lg-3 col-xs-12 col-md-3 footer-block pe-2">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-3') ? 'footer_hide' : esc_attr($vw_sports_colmd); ?> col-lg-3 col-xs-12 col-md-3 footer-block">
                        ...
                        <div class="<?php echo !is_active_sidebar('footer-4') ? 'footer_hide' : esc_attr($vw_sports_colmd); ?> col-lg-3 col-xs-12 col-md-3 footer-block">
        ...
        <?php }?>
        <div class="footer <?php if( get_theme_mod( 'vw_sports_copyright_sticky', false) == 1) { ?> copyright-sticky"<?php } else { ?>close-sticky <?php } ?>">
     ...
     <?php if ( get_theme_mod( 'vw_sports_progress_bar', 0 ) ) : ?>
        <div id="vw_sports_elemento_progress_bar"></div>
    <?php endif; ?>
        <?php wp_footer(); ?>
    </body>
</html>