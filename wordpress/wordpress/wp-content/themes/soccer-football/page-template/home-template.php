...
<main id="skip-content">
  <section id="top-slider" slider-loop="<?php echo esc_html(get_theme_mod('football_sports_club_slider_loop')); ?>">
     <?php if(get_theme_mod('football_sports_club_slider_setting',true) != ''){ ?>
      ...
      <?php  while ( $football_sports_club_query->have_posts() ) : $football_sports_club_query->the_post(); ?>
        <div class="slider-box">
          ...
          <div class="slider-inner-box">
            <?php if(get_theme_mod('football_sports_club_slider_title_setting',1) == 1){ ?>
              <h1><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
            <?php }?>
            <?php if(get_theme_mod('football_sports_club_slider_content_setting',1) == 1){ ?>
              <p><?php echo wp_trim_words( get_the_content(), esc_attr(get_theme_mod('football_sports_club_slider_excerpt_length', 30)) ); ?></p>
            <?php }?>
            <?php if(get_theme_mod('football_sports_club_slider_button_setting',1) == 1 && get_theme_mod('football_sports_club_slider_button_text','Register Now') != ''){ ?>
              <div class="slider-box-btn mt-4">
                <a href="<?php the_permalink(); ?>"><?php esc_html_e(get_theme_mod('football_sports_club_slider_button_text','Register Now')); ?></a>
              </div>
            <?php }?>
          </div>
        </div>
...
<?php if(get_theme_mod('football_sports_club_activity_setting',true) != ''){ ?>
